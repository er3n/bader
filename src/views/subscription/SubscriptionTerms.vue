<template>
  <div class="col-12 col-md-9">
    ...
    <hr>
    <p>
            Üyelik koşulları aşağıda gereksinimler bulunmaktadır.
    </p>
    <ul class="list-group">
        <li class="list-group-item">Türk  vatandaşı olmak.</li>
        ...
        <li class="list-group-item">2 adet vesikalık fotoğraf.</li>
    </ul>
  </div>
</template>
